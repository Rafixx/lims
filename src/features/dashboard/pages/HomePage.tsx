...
export const HomePage = () => (
  <div className="space-y-8">
    {/* Sección principal */}
    <div>
      <h2 className="text-xl sm:text-2xl font-bold text-surface-900 mb-4">Área de Trabajo</h2>
    ...
    <div>
      <h2 className="text-xl sm:text-2xl font-bold text-surface-900 mb-4">Configuración</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <DashboardCard
