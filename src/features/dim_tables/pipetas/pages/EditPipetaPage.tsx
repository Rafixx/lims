...
import { usePipeta } from '@/shared/hooks/useDim_tables'
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-foreground-primary">Editar Pipeta</h1>
        </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-foreground-secondary mt-1">
            Modificando: <span className="font-medium">{pipeta.codigo}</span>
          </p>
        </div>
      </div>
