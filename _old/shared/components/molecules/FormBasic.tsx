...
import SortableList from './SortableList' // Ajusta la ruta según corresponda
import { DropdownWithAdd, FormValues } from './DropdownAddForm'
...
export interface FieldConfig {
  ...
  // Propiedades específicas para el campo dropdownWithAdd:
  dropdownOptions?: { label: string; value: string }[]
  onDropdownAdd?: (newOption: { label: string; value: string }) => void
  dropdownFormFields?: FieldConfig[]
  dropdownFormDefaultValues?: FormValues // Tipo correcto para coincidir con DropdownWithAdd
}
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <DropdownWithAdd
                  ...
                  // Se transforma el evento en el valor, para integrarse con react-hook-form.
                  onChange={e => onChange(e.target.value)}
                  onAdd={field.onDropdownAdd!}
                  formFields={field.dropdownFormFields!}
                  formDefaultValues={field.dropdownFormDefaultValues!}
                />
              )}
            />
          ) : (
